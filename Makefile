...
$(eval $(call build-package,xz,5.2.9-r0))
...
$(eval $(call build-package,py3-gpep517,11-r0))
...
$(eval $(call build-package,py3-more-itertools,9.0.0-r0))
...
$(eval $(call build-package,trivy,0.35.0-r0))
...
$(eval $(call build-package,meson,0.64.1-r0))
