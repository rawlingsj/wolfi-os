...
$(eval $(call build-package,grep,3.10-r0))
...
$(eval $(call build-package,ca-certificates,20230106-r0))
...
$(eval $(call build-package,xz,5.4.2-r0))
$(eval $(call build-package,python-3.11,3.11.2-r0))
...
$(eval $(call build-package,hello-wolfi,2.12-r1))
...
$(eval $(call build-package,curl,8.0.1-r0))
$(eval $(call build-package,attr,2.5.1-r2))
$(eval $(call build-package,acl,2.3.1-r2))
$(eval $(call build-package,coreutils,9.2-r0))
...
$(eval $(call build-package,git,2.40.0-r0))
...
$(eval $(call build-package,ruby-3.0,3.0.5-r1))
$(eval $(call build-package,ruby-3.1,3.1.3-r5))
$(eval $(call build-package,ruby-3.2,3.2.1-r1))
...
$(eval $(call build-package,libgit2,1.6.3-r0))
$(eval $(call build-package,meson,1.0.1-r0))
$(eval $(call build-package,wasi-libc,0.20220525-r2))
$(eval $(call build-package,rust,1.68.2-r0))
$(eval $(call build-package,deno,1.32.3-r0))
...
$(eval $(call build-package,util-macros,1.20.0-r0))
...
$(eval $(call build-package,prometheus,2.43.0-r0))
...
$(eval $(call build-package,check,0.15.2-r3))
$(eval $(call build-package,libice,1.1.1-r0))
$(eval $(call build-package,libsm,1.2.4-r0))
...
$(eval $(call build-package,nodejs-19,19.8.1-r0))
...
$(eval $(call build-package,lcms2,2.15-r0))
$(eval $(call build-package,openjdk-11,11.0.19.5-r1))
$(eval $(call build-package,openjdk-17,17.0.7.5-r1))
$(eval $(call build-package,su-exec,0.2-r1))
$(eval $(call build-package,llvm15,15.0.7-r1))
...
$(eval $(call build-package,tzdata,2023c-r0))
$(eval $(call build-package,maven-stage0,3.9.1-r0))
$(eval $(call build-package,maven,3.9.1-r1))
...
$(eval $(call build-package,bazel-6,6.1.1-r0,bazel))
$(eval $(call build-package,libmaxminddb,1.7.1-r1))
$(eval $(call build-package,clang-15,15.0.7-r0))
$(eval $(call build-package,jenkins,2.397-r0))
$(eval $(call build-package,cosign,2.0.0-r1))
$(eval $(call build-package,yasm,1.3.0-r0))
$(eval $(call build-package,crane,0.14.0-r0))
...
$(eval $(call build-package,kubectl,1.26.3-r0))
...
$(eval $(call build-package,llvm-libunwind,16.0.0-r0))
...
$(eval $(call build-package,envoy,1.25.2-r0))
$(eval $(call build-package,redis,7.0.10-r0))
$(eval $(call build-package,mailcap,2.1.53-r0))
$(eval $(call build-package,php,8.2.4-r0))
...
$(eval $(call build-package,mariadb-10.6,10.6.12-r1,mariadb))
$(eval $(call build-package,mariadb-10.11,10.11.2-r0,mariadb))
$(eval $(call build-package,wait-for-it,0.20200823-r1))
$(eval $(call build-package,argon2,20190702-r0))
$(eval $(call build-package,haproxy,2.6.11-r0))
$(eval $(call build-package,vault,1.13.1-r1))
$(eval $(call build-package,vault-k8s,1.2.0-r2))
...
$(eval $(call build-package,rabbitmq-server,3.11.13-r0))
...
$(eval $(call build-package,apko,0.7.3-r0))
$(eval $(call build-package,melange,0.3.2-r0))
...
$(eval $(call build-package,kustomize,5.0.1-r0))
...
$(eval $(call build-package,python-3.10,3.10.10-r0))
...
$(eval $(call build-package,fluent-bit,2.0.10-r1))
$(eval $(call build-package,sbom-scorecard,0.0.5-r1))
$(eval $(call build-package,libaio,0.3.113-r1))
$(eval $(call build-package,flux,0.41.2-r0))
$(eval $(call build-package,libunwind,1.6.2-r1))
...
$(eval $(call build-package,vim,9.0.1402-r0))
...
$(eval $(call build-package,oras,0.16.0-r2))
...
$(eval $(call build-package,ruby3.0-bundler,2.4.8-r0))
$(eval $(call build-package,ruby3.1-bundler,2.4.8-r0))
$(eval $(call build-package,ruby3.2-bundler,2.4.8-r1))
$(eval $(call build-package,ruby3.2-async-io,1.34.3-r2))
$(eval $(call build-package,ruby3.2-cool.io,1.7.1-r1))
$(eval $(call build-package,ruby3.2-fiber-local,1.0.0-r1))
$(eval $(call build-package,ruby3.2-fluentd14,1.14.6-r3))
$(eval $(call build-package,ruby3.2-fluentd15,1.15.3-r2))
$(eval $(call build-package,ruby3.2-msgpack,1.6.0-r1))
$(eval $(call build-package,ruby3.2-oj,3.14.2-r1))
$(eval $(call build-package,ruby3.2-rexml,3.2.5-r1))
$(eval $(call build-package,ruby3.2-serverengine,2.3.1-r2))
$(eval $(call build-package,ruby3.2-sigdump,0.2.4-r1))
$(eval $(call build-package,ruby3.2-strptime,0.2.5-r1))
$(eval $(call build-package,ruby3.2-tzinfo-data,1.2022.7-r2))
$(eval $(call build-package,ruby3.2-tzinfo,2.0.6-r2))
$(eval $(call build-package,ruby3.2-webrick,1.7.0-r1))
$(eval $(call build-package,ruby3.2-async-http,0.60.1-r2))
$(eval $(call build-package,ruby3.2-async-pool,0.3.12-r2))
$(eval $(call build-package,ruby3.2-async,2.3.1-r2))
$(eval $(call build-package,ruby3.2-console,1.16.2-r2))
$(eval $(call build-package,ruby3.2-io-event,1.1.6-r1))
$(eval $(call build-package,ruby3.2-protocol-http1,0.15.0-r2))
$(eval $(call build-package,ruby3.2-protocol-http2,0.15.1-r2))
$(eval $(call build-package,ruby3.2-protocol-http,0.24.1-r1))
$(eval $(call build-package,ruby3.2-timers,4.3.5-r1))
$(eval $(call build-package,ruby3.2-traces,0.8.0-r1))
$(eval $(call build-package,ruby3.2-concurrent-ruby,1.2.0-r1))
$(eval $(call build-package,ruby3.2-http_parser.rb,0.8.0-r1))
$(eval $(call build-package,ruby3.2-protocol-hpack,1.4.2-r1))
$(eval $(call build-package,ruby3.2-yajl-ruby,1.4.3-r1))
...
$(eval $(call build-package,golangci-lint,1.51.1-r2))
...
$(eval $(call build-package,dotnet-7,7.0.104-r1))
...
$(eval $(call build-package,clamav,1.0.1-r0))
...
$(eval $(call build-package,checkov,2.3.114-r0))
...
$(eval $(call build-package,consul,1.15.2-r0))
$(eval $(call build-package,sshpass,1.10-r0))
$(eval $(call build-package,restic,0.15.1-r1))
...
$(eval $(call build-package,prometheus-postgres-exporter,0.12.0-r0))
$(eval $(call build-package,prometheus-elasticsearch-exporter,1.5.0-r0))
