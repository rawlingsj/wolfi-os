...
$(eval $(call build-package,deno,1.29.1-r2))
...
$(eval $(call build-package,python3,3.11.1-r3))
...
$(eval $(call build-package,nghttp2,1.49.0-r2))
$(eval $(call build-package,curl,7.87.0-r3))
...
$(eval $(call build-package,procps,4.0.2-r2))
$(eval $(call build-package,samurai,1.2-r2))
$(eval $(call build-package,lz4,1.9.4-r2))
$(eval $(call build-package,zstd,1.5.2-r2))
...
$(eval $(call build-package,py3-setuptools,59.4.0-r3))
...
$(eval $(call build-package,py3-pip,22.3.1-r2))
...
$(eval $(call build-package,git,2.39.1-r2))
$(eval $(call build-package,bash,5.2.15-r2))
$(eval $(call build-package,go-stage0,1.19.1-r2))
$(eval $(call build-package,go-1.18,1.18.9-r3))
$(eval $(call build-package,go-1.19,1.19.5-r3))
$(eval $(call build-package,go-1.20,1.20_rc1-r4))
$(eval $(call build-package,git-lfs,3.3.0-r2))
$(eval $(call build-package,openssh,9.0_p1-r2))
$(eval $(call build-package,skalibs,2.13.0.0-r2))
$(eval $(call build-package,execline,2.9.1.0-r2))
$(eval $(call build-package,s6,2.11.2.0-r2))
$(eval $(call build-package,libretls,3.5.2-r2))
$(eval $(call build-package,grype,0.56.0-r0))
$(eval $(call build-package,trivy,0.36.1-r2))
...
$(eval $(call build-package,rust,1.66.0-r0))
...
$(eval $(call build-package,prometheus,2.41.0-r2))
...
$(eval $(call build-package,libx11,1.8.3-r2))
...
$(eval $(call build-package,nodejs,18.13.0-r2))
...
$(eval $(call build-package,freetype,2.12.1-r2))
$(eval $(call build-package,fontconfig,2.14.1-r2))
$(eval $(call build-package,giflib,5.2.1-r2))
$(eval $(call build-package,libjpeg,2.1.4-r2))
...
$(eval $(call build-package,postgresql-11,11.18-r1,postgresql))
$(eval $(call build-package,postgresql-12,12.13-r1,postgresql))
$(eval $(call build-package,postgresql-13,13.9-r1,postgresql))
$(eval $(call build-package,postgresql-14,14.6-r1,postgresql))
...
$(eval $(call build-package,jenkins,2.387-r1))
$(eval $(call build-package,cosign,2.1.5cg19-r0))
...
$(eval $(call build-package,kubectl,1.26.0-r0))
...
$(eval $(call build-package,mariadb,10.6.11-r3))
$(eval $(call build-package,wait-for-it,0.20200823-r1))
$(eval $(call build-package,haproxy,2.6.8-r0))
$(eval $(call build-package,vault,1.12.2-r0))
...
$(eval $(call build-package,rabbitmq-server,3.11.7-r0))
...
$(eval $(call build-package,kustomize,4.5.7-r0))
...
$(eval $(call build-package,flux,0.38.2-r0))
