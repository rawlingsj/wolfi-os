...
$(eval $(call build-package,openssl,3.1.0-r1))
...
$(eval $(call build-package,hello-wolfi,2.12-r0))
...
$(eval $(call build-package,deno,1.32.1-r0))
...
$(eval $(call build-package,util-macros,1.19.3-r3))
...
$(eval $(call build-package,libice,1.0.10-r3))
$(eval $(call build-package,libsm,1.2.3-r3))
...
$(eval $(call build-package,tzdata,2023b-r0))
...
$(eval $(call build-package,jenkins,2.396-r0))
...
$(eval $(call build-package,rabbitmq-server,3.11.11-r0))
...
$(eval $(call build-package,apko,0.7.2-r1))
