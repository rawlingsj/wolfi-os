...
$(eval $(call build-package,trivy,0.38.3-r0))
...
$(eval $(call build-package,vault,1.13.0-r2))
$(eval $(call build-package,vault-k8s,1.2.0-r1))
...
$(eval $(call build-package,rabbitmq-server,3.11.12-r0))
...
$(eval $(call build-package,fluent-bit,2.0.10-r0))
