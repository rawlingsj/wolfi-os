...
$(eval $(call build-package,libarchive,3.6.2-r0))
...
$(eval $(call build-package,openjdk-11,11.0.17.8-r2))
$(eval $(call build-package,openjdk-17,17.0.5.8-r2))
...
$(eval $(call build-package,crane,0.12.1-r1))
