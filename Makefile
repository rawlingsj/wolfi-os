...
$(eval $(call build-package,openjdk-11,11.0.18-ga-r1))
$(eval $(call build-package,openjdk-17,17.0.6-ga-r1))
...
$(eval $(call build-package,kubectl,1.26.2-r0))
...
$(eval $(call build-package,ruby3.2-fluentd14,1.14.6-r0))
$(eval $(call build-package,ruby3.2-fluentd15,1.15.3-r0))
