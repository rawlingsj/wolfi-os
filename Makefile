...
$(eval $(call build-package,sqlite,3.40.0-r1))
$(eval $(call build-package,xz,5.4.0-r0))
$(eval $(call build-package,python3,3.11.1-r0))
...
$(eval $(call build-package,go-1.20,1.20rc1-r0))
...
$(eval $(call build-package,grype,0.54.0-r0))
$(eval $(call build-package,trivy,0.35.0-r0))
$(eval $(call build-package,ruby-3.0,3.0.4-r0))
$(eval $(call build-package,ruby-3.1,3.1.3-r0))
$(eval $(call build-package,ruby-3.2,3.2.0-r1))
...
$(eval $(call build-package,openjdk-11,11.0.17.8-r4))
$(eval $(call build-package,openjdk-17,17.0.5.8-r4))
...
$(eval $(call build-package,wasi-libc,0.20220525-r0))
$(eval $(call build-package,jenkins,2.383-r0))
